...
--no-use_img2img --img2img_strength $img2img_strength --use_global --no-use_local --use_non_linear_local \
...
--subj_list 1 2 5 7 --subj_load $subj_load --subj_test $subj_test --length 982 \
