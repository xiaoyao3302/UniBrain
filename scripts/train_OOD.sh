...
main.py \
--model_name $model_name --subj_list 1 2 5 --subj_test_list 7 --wandb_log --type_model $type_model --use_global --no-use_local --use_non_linear_local \
